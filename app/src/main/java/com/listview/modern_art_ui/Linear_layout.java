...
public class Linear_layout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vuong1=findViewById(R.id.txt_vuong1);
        vuong2=findViewById(R.id.txt_vuong2);
        vuong3=findViewById(R.id.txt_vuong3);
        vuong4=findViewById(R.id.txt_vuong4);
        vuong5=findViewById(R.id.txt_vuong5);
